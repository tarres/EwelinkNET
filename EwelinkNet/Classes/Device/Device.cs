...
namespace EwelinkNet.Classes
{
    public class Device
    {
        ...
        public string GetStringParameter(string parameterName) => ExpandoHelpers.GetOrDefault(@params, parameterName);

        public long GetLongParameter(string parameterName) => ExpandoHelpers.GetOrDefault(@params, parameterName);
